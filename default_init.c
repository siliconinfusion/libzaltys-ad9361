/**************************************************************************************************
    ...
    Copyright 2014 - 2016 Silicon Infusion Limited
...
***************************************************************************************************
    ...
    Toplevel initialisation routine for the AD9361 driver.

    Call either the ad9361_lvds_init() function or the ad9361_cmos_init() function from VB code
...
/*
** Toplevel initialisation parameters
*/
...
/*
** Toplevel initialisation routines -- called from VB code
*/
struct ad9361_rf_phy *ad9361_lvds_init ()
{
	AD9361_InitParam init_params = default_init_param;
	init_params.lvds_mode_enable = 1;

	return ad9361_init(&init_params);
}

struct ad9361_rf_phy *ad9361_cmos_init ()
{
        AD9361_InitParam init_params = default_init_param;
        init_params.lvds_mode_enable = 0;
        init_params.lvds_rx_onchip_termination_enable = 0;
        init_params.full_port_enable = 1;
        /* init_params.swap_ports_enable = 1; */
